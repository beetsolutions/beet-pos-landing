                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-12 items-center'>
                        <div className='col-span-6'>
                            ...
                            <h1 className="text-2xl lg:text-5xl font-semibold mb-5 text-black dark:text-white md:4px lg:text-start text-center">
                                Delight your diners with flexible restaurant, nightclub, bar gift cards
                            </h1>
                            <p className='text-black/55 dark:text-white/50 lg:text-lg font-normal mb-10 lg:text-start text-center'>
                                Offer guests a simple way to share their love for your restaurant, nightclub, bar with both digital and physical options.
                            </p>
                        ...
                        <div className='col-span-6 flex justify-center relative'>
                            <Image src="/images/hero/gift-card.avif" alt="nothing" width={1000} height={805} />
                        </div>
                    </div>
                </div>
            </section>
