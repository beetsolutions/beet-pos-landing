                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-12 items-center gap-8'>
                        <div className='col-span-6'>
                            ...
                            <p className='text-black/55 dark:text-white/50 lg:text-lg font-normal mb-10 lg:text-start text-center'>
                                BEET POS is designed specifically for fast food restaurants. Speed up order taking, streamline kitchen operations, and deliver exceptional customer service with our intuitive quick-service restaurant POS system.
                            </p>
                ...
                <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                    <div className='text-center mb-16'>
                        <h2 className="text-3xl lg:text-5xl font-semibold text-black dark:text-white mb-5">
                            Why Choose BEET POS for Your Fast Food Restaurant?
                        </h2>
                        <p className='text-black/60 dark:text-white/60 lg:text-lg max-w-3xl mx-auto'>
                            Our POS system is built to handle the unique demands of quick-service restaurants, helping you serve customers faster and run your business more efficiently.
                        </p>
                    </div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                        <div className='p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow'>
                            ...
                            <h3 className='text-2xl font-semibold text-black dark:text-white mb-4'>
                                Lightning-Fast Order Taking
                            </h3>
                            <p className='text-black/60 dark:text-white/60'>
                                Take orders in seconds with our intuitive interface. Customizable menu layouts and quick modifiers keep your drive-thru and counter lines moving.
                            </p>
                        </div>
                        ...
                        <div className='p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow'>
                            ...
                            <p className='text-black/60 dark:text-white/60'>
                                Send orders directly to the kitchen with real-time order tracking. Color-coded displays and order timers ensure nothing gets missed.
                            </p>
                        </div>
                        ...
                        <div className='p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow'>
                            ...
                            <p className='text-black/60 dark:text-white/60'>
                                Accept all payment types including cash, cards, mobile wallets, and contactless payments. Split bills and process refunds with ease.
                            </p>
                        </div>
                        ...
                        <div className='p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow'>
                            ...
                            <p className='text-black/60 dark:text-white/60'>
                                Easily update menu items, pricing, and modifiers across all locations. Schedule menu changes for different dayparts and promotions.
                            </p>
                        </div>
                        ...
                        <div className='p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow'>
                            ...
                            <p className='text-black/60 dark:text-white/60'>
                                Track sales, monitor peak hours, identify top-selling items, and make data-driven decisions with comprehensive reporting tools.
                            </p>
                        </div>
                        ...
                        <div className='p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow'>
                            ...
                            <p className='text-black/60 dark:text-white/60'>
                                Manage staff schedules, track clock-in/out times, set permissions, and monitor employee performance all from one system.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-16'>
                        <div className='col-span-6 flex flex-col justify-center'>
                            <h2 className="text-3xl lg:text-5xl font-semibold text-black dark:text-white text-start mb-6">
                                Built for Quick-Service Excellence
                            </h2>
                            <p className='text-black/60 dark:text-white/60 font-normal text-start mb-6'>
                                From drive-thru to dine-in, BEET POS handles the complexity of fast food operations with ease. Our system supports online ordering integration, delivery management, and loyalty programs to keep your customers coming back.
                            </p>
                            <ul className='space-y-4'>
                                <li className='flex items-start'>
                                    ...
                                    <span className='text-black/60 dark:text-white/60'>Drive-thru timer and order management</span>
                                </li>
                                <li className='flex items-start'>
                                    <svg className="w-6 h-6 text-primary mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span className='text-black/60 dark:text-white/60'>Online ordering and third-party delivery integration</span>
                                </li>
                                <li className='flex items-start'>
                                    <svg className="w-6 h-6 text-primary mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span className='text-black/60 dark:text-white/60'>Customer loyalty and rewards programs</span>
                                </li>
                                <li className='flex items-start'>
                                    <svg className="w-6 h-6 text-primary mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span className='text-black/60 dark:text-white/60'>Combo meal and upsell prompts</span>
                                </li>
                                <li className='flex items-start'>
                                    <svg className="w-6 h-6 text-primary mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span className='text-black/60 dark:text-white/60'>Multi-location management and reporting</span>
                                </li>
                            </ul>
                        </div>
                        <div className='col-span-6 flex justify-center'>
                            <Image src="/images/hero/team.jpg" alt="Fast Food Restaurant Team" width={636} height={808} className="rounded-3xl shadow-2xl" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className='relative py-16'>
                <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                    <div className='text-center mb-12'>
                        <h2 className="text-3xl lg:text-5xl font-semibold text-black dark:text-white mb-5">
                            Ready to Speed Up Your Fast Food Service?
                        </h2>
                        <p className='text-black/60 dark:text-white/60 lg:text-lg max-w-3xl mx-auto mb-8'>
                            Join thousands of fast food restaurant owners who trust BEET POS to power their business. Get started today with a free demo.
                        </p>
