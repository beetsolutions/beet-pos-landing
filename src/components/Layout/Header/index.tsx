      ...
      <div className="lg:py-0 py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="#"
              className="hidden lg:block text-primary ml-2 bg-primary/15 hover:text-white hover:bg-primary font-medium text-lg py-2 px-6 rounded-full"
              onClick={() => {
            ...
            <Link
              href="#"
              className="hidden lg:block bg-primary text-white hover:bg-primary/15 hover:text-primary font-medium text-lg py-2 px-6 rounded-full "
              onClick={() => {
        ...
        >
          <div className="flex items-center justify-between pt-4">
            ...
            <button
              ...
              className="bg-[url('/images/closed.svg')] bg-no-repeat bg-contain w-6 h-6 absolute top-0 right-0 mr-4 mt-4 dark:invert"
